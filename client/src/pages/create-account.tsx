          ...
          <CardContent className="p-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h4 className="font-semibold mb-2">Get Your Customer ID</h4>
                <p className="text-sm text-gray-600">
                  You'll receive a Customer ID when you become our customer
                </p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h4 className="font-semibold mb-2">Register Your Account</h4>
                <p className="text-sm text-gray-600">
                  Use your Customer ID to create your secure online account
                </p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h4 className="font-semibold mb-2">Start Managing Online</h4>
                <p className="text-sm text-gray-600">
                  Access all your information and manage your account 24/7
                </p>
              </div>
            </div>
          </CardContent>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">View and download orders</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Track shipments in real-time</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Access invoices and statements</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Review payment history</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Manage estimates and quotes</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Secure password protection</span>
                  </li>
                  <li className="flex items-start">
                    <ShieldCheck className="h-5 w-5 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <ShieldCheck className="h-5 w-5 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Customer-specific data access</span>
                  </li>
                  <li className="flex items-start">
                    <ShieldCheck className="h-5 w-5 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Password reset via email</span>
                  </li>
                  <li className="flex items-start">
                    <ShieldCheck className="h-5 w-5 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Session management controls</span>
                  </li>
                </ul>
              </div>
            </div>
